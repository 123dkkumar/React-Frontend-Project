  ...
  justify-center container mx-auto p-14 md:px-20 lg:px-32 w-full overflow-hidden "
    ...
    >
      <h1 className="text-2xl sm:text-4xl font-bold mb-2 ">
        About{" "}
        <span className="underline underline-offset-4 decoration-3 under cursor-pointer font-light text-blue-700 hover:text-yellow-700">
          Our Brand{" "}
        </span>
      </h1>
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start md:gap-20">
        <img
          ...
          alt=""
          className=" sm:w-2/3 max-w-lg  w-70 h-70 object-cover rounded-full border transition-transform duration-300 mt-20 hover:scale-110 "
        />
        <div className="flex flex-col items-center md:items-start mt-10 text-gray-600">
          ...
          <button className="bg-blue-600 text-white px-8 py-2 rounded  hover:bg-black  ">
            Learn More
          </button>
        </div>
      </div>
